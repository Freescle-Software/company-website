...
const Header = () => {
    ...
    return (
        <nav
            className="sticky top-3 z-20 w-full md:w-6xl bg-white rounded-2xl border-2 border-solid border-violet-900 shadow-[0_0_10px_5px_rgba(102,51,153,0.6)]">
            <div className={`flex ${isToggleopen?'flex-col':'flex-row'} md:grid md:grid-cols-6 w-[100%]`}>
                ...
                <div className="place-content-center place-items-center p-3 m-3 md:p-2 md:m-2">
                    <button className={`${isToggleopen ? '': 'hidden'} rounded-xl md:flex font-serif`}>Contact Us</button>
